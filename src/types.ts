...
export interface Session {
  ...
  // Extension & feedback times
  originalEndTime?: string;
  extendedEndTime?: string;
  actualEndTime?: string;
  extensionHistory?: Array<{ timestamp: string; duration: number }>;
  feedbackDeadline?: string; // ISO string
  feedbackClosingTime?: string; // ISO string (deprecated alias)
  notes?: string;
...
export interface AttendanceRecord {
  ...
  method: 'qr' | 'manual';
  markedBy?: string;
  scanningAdminId?: string;
  scanningAdminName?: string;
}
...
export interface AbsenceRequestHistoryEntry {
  action: string;
  adminName?: string;
  timestamp: string;
}
